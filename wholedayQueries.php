...
$query = "SELECT ROUND(COUNT(*)/(SELECT count(*) from `wholeday`) * 100, 0) FROM `wholeday` WHERE O_R_Weekdays <> 0 AND O_R_Weekdays <> 1";
...
$query2 = "SELECT ROUND(COUNT(*)/(SELECT count(*) from `wholeday`) * 100, 0) FROM `wholeday` WHERE B_R_Weekdays <> 0 AND B_R_Weekdays <> 1";
...
$query3 = "SELECT ROUND(COUNT(*)/(SELECT count(*) from `wholeday`) * 100, 0) FROM `wholeday` WHERE O_R_Weekdays = 0";
...
$query4 = "SELECT ROUND(COUNT(*)/(SELECT count(*) from `wholeday`) * 100, 0) FROM `wholeday` WHERE B_R_Weekdays = 0";
...
$query5 = "SELECT ROUND(COUNT(*)/(SELECT count(*) from `wholeday`) * 100, 0) FROM `wholeday` WHERE O_R_Weekdays = 1";
...
$query6 = "SELECT ROUND(COUNT(*)/(SELECT count(*) from `wholeday`) * 100, 0) FROM `wholeday` WHERE B_R_Weekdays = 1";
